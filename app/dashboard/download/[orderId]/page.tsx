...
import { Download, FileArchive, Clock, CheckCircle, AlertCircle, ArrowLeft } from "lucide-react"
      ...
      <div className={`flex-1 transition-all duration-300 ${isCollapsed ? "lg:pl-16" : "lg:pl-64"}`}>
        <div className="p-6">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold">Tải xuống Source Code</h1>
            <p className="text-muted-foreground mt-2">Tải xuống file source code đã mua</p>
          </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      <CardTitle className="flex items-center gap-2">
                        ...
                        {downloadInfo.productName}
                      </CardTitle>
                      <CardDescription>Mã đơn hàng: {downloadInfo.orderId}</CardDescription>
                    </div>
                    <Badge 
